...
[description]:        # "I've deployed an official Apache Mirror. In this post, I'll explain to you how to deploy yours easily with Docker."
...
In order to deploy your mirror, you need a web server and a synchronizing task that is performed with **rsync**. The Docker container will retrieve changes from the source server twice a day. And that's it.
